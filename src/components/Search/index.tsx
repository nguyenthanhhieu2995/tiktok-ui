        ...
        <div>
            ...
            >
                <input
                    ...
                    placeholder="Search"
                    className="px-2 bg-transparent outline-none focus:outline-none grow caret-rose-600 text-gray-700 pointer-events-auto peer placeholder-gray-500"
                />
            ...
            {/* {dropdown search} */}
            {state.inputSearch.length > 0 && showResult && <DropDownSearch />}
        </div>
    );
}
